...
function Customers({ buttonText, popupContent }) {
      ...
      <div>
        {loader ? (
          ...
          >
            ...
            <div class="text-2xl font-bold text-gray-800 mb-4 mt-2">Customer</div>
            <div
                                ...
                                <div className="rounded-md shadow-sm  space-y-4">
                                  ...
                                  <div>
                                    ...
                                    <input
                                      ...
                                      value={customersData.credit_amount}
                                    />
                                  </div>
                                </div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg lg:mt-[1%] xl:w-[80]">
              ...
              {customersList?.length > 0 ? (
                <table class="w-full text-sm font-[500] text-left rtl:text-right text-gray-900 dark:text-gray-400">
                  ...
                  <tbody>
                    {customersList.length > 0
                      ? Object.values(customersList)?.map((item, index) => (
                          <tr
                            key={index}
                          ...
                          >
                            ...
                            <td class="px-6 py-4">{item?.gst_no}</td>
                            <td class="px-6 py-4">{item?.credit_amount}</td>
                            <td class="px-6 py-4 flex gap-3">
                              ...
                              <a
                                onClick={() => {
                                  ...
                                  setPopUpHeaderName("Edit Customers");
                                  setErrors({});
                                  setIsEdit(true);
                                }}
                                href="#"
